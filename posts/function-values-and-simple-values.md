...
Случаи, когда может понадобиться использовать трюк с двойными обратными кавычками:
